...
time.sleep(2)
time.sleep(2) 
el = ElementFinder(driver, 184,1197) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 336,1144) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 645,143) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 192,1144) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 32,772) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 32,1108) 
el.click()
