...
el.click()
time.sleep(2) 
el = ElementFinder(driver, 136,628) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 670,755) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 193,32) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 136,628) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 269,934) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 136,508) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 48,1148) 
el.click()
