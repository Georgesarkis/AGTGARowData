...
el.click()
time.sleep(2) 
el = ElementFinder(driver, 427,244) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 855,1036) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 839,849) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 0,61) 
el.click()
...
el.click()
time.sleep(2) 
el = ElementFinder(driver, 136,1299) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 0,61) 
el.click()
time.sleep(2) 
el = ElementFinder(driver, 958,71) 
el.click()
